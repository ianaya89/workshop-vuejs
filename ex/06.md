...
Listo, nuestra aplicacion ya se esta ejecutando en el (http://localhost:8080)[http://localhost:8080] y ya tenemos todo lo que necesitamos para empezar a trabajar con Vue de forma profesional.
